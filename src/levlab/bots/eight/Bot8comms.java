 ...
 */
public class Bot8comms extends Thread {
    ...
    public void run(){
 	   ...
 	   while(true){
 		   ...
 		   // BT_NOT
 		   if(local.btState == Bot8shared.BT_NOT){
 			  local.connect = null;
 			  local.dataIn = null;
 			  local.dataOut = null;
 		      ...
 		      if(local.connect!=null){
 		    	  ...
 		    	  if(local.dataIn!=null){
 		    		  ...
 		    		  if(local.dataOut!=null){
 		    			  local.btState = Bot8shared.BT_OK;
 		   ...
 		   // BT_ERROR
 		   if(local.btState == Bot8shared.BT_ERROR){
 			   local.dataIn = null;
 			   local.dataIn = null;
 			   local.connect = null; 	
 			   local.btState = Bot8shared.BT_NOT;
