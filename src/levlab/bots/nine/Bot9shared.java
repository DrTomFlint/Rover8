...
public class Bot9shared {
		...
		private static Bot9shared instance = new Bot9shared();
		
		// Make the static instance available publicly thru method
		public static Bot9shared getInstance() { return instance; }
		...
		// Handles for the 4 sensors, (ports defined in Bot9.java)
		ColorSensor lamp;
