...
/* This class is revised so that it just reads values from Bot9shared singleton
 * and reports them out the bluetooth connection.  At the other end, the run() 
 * method of Bot9cmd (part of the TestOne servlet) is constantly reading the 
 * data and putting it into the Shared singleton in the tomcat server.
 * 
 * Dr Tom Flint, Leverett Laboratory, 23 Jan 2014.
 * 
 */
   public class Bot9reporter extends Thread {
