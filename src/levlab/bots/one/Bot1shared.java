...
public class Bot1shared {
		...
		private static Bot1shared instance = new Bot1shared();
		
		// Make the static instance available publicly thru method
		public static Bot1shared getInstance() { return instance; }
		...
		// Handles for the 4 sensors, (ports defined in Bot1.java)
		ColorSensor lamp;
